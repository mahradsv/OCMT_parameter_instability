function [obj1,obj2]= Predict_Lasso_no_inta(y,Z,X,Zf,Xf,compute_also_ALasso,weight) %ppp_weight is from equation 46, 47, and 48 of Pesaran, Pick and Pranovich(2013,JoE)
...
for i = 1:length(weight)
    w = weight(i);
    w_reg = (w.^([sum(set)-1:-1:0]')* ones(1,size(reg,2)) ).* reg;
